...
const Create=({auth,personalData,documentoData,exdocenteData,exlaboralData,familiaData,neducativoData,otrotrabajoData,resolucionesycontratoData}) => {
  ...
  // })
    ...
    const submit = (e)=>{
        e.preventDefault()
        post(route('personal.store'),{onSuccess: ()=>reset()})
    }
    const familia = (e)=>{
      e.preventDefault()
      console.log(data)
  ...
  return (
    <AuthenticatedLayout auth={auth}>
        ...
        {/* {popup&& */}
          ...
          <h3 className='uppercase tracking-wide text-black text-xl border-b border-gray-400 font-bold mb-3'>Escalafon - Hoja de registro</h3>
          ...
          <div className="-mx-3 md:flex mb-4">
                ...
                <label className="uppercase tracking-wide text-black text-xs font-bold mb-2" htmlFor="fecha_Ingreso_undac">
                    Fecha de ingreso a la undac
                  </label>
                  <input autoFocus value={data.fecha_Ingreso_undac} onChange={e=>setData('fecha_Ingreso_undac',e.target.value)} type="date" className='hover:bg-gray-300 w-full bg-gray-200 text-black border border-gray-200 rounded py-3 px-4 mb-3 '  id="fecha_Ingreso_undac" />
          ...
          <div className="-mx-3 md:flex mb-2">
                ...
                <div className="w-1/4 px-3">
                  ...
                  <select onChange={e=>setData('estado',e.target.value)} id="estado" className='hover:bg-gray-300 w-full bg-gray-200 text-black border border-gray-200 text-sm rounded py-3 px-4 mb-3 font-medium' name="estado">
                    ...
                    <option value="FEMENINO">CESADO</option>
              ...
              <div className="flex">
                ...
                <div className="flex my-4 justify-between">
                      ...
                      <div className="flex items-center">
                          <input checked={data.docente_t=="DCU" ? true : false} onChange={e=>setData('docente_t',e.target.value)} id="inline-e4-radio-D" type="radio" value="DCU" name="inline-radio-group-Doc" className="hover:bg-gray-300 w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"/>
                          <label htmlFor="inline-e4-radio-D" className="uppercase ml-3 text-sm font-medium text-gray-900 dark:text-gray-300">DCU</label>
                      </div>  
                </div>
            ...
            <h3 className='uppercase tracking-wide text-black border-b border-gray-400 text-xm font-bold mb-3'>DATOS PERSONALES</h3>
              ...
              <div className="-mx-3 md:flex mb-2">
                ...
                <div className="w-1/4 px-3">
                  <label className="uppercase tracking-wide text-black text-xs font-bold mb-2" htmlFor="carnet_identidad">
                    CARNET DE IDENTIDAD
                  </label>
            ...
            hover:file:cursor-pointer hover:file:opacity-90 w-full " />
              ...
              <div className="-mx-3 md:flex mb-2">
                <div className=" w-1/3 px-3">
                      ...
                      <div className="flex my-4 justify-between">
                      <div className="flex items-center">
                          <input checked={data.regimen_pensionario=="1990" ? true : false} onChange={e=>setData('regimen_pensionario',e.target.value)} id="inline-radio" type="radio" value="1990" name="inline-radio-group" className="hover:bg-gray-300 w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"/>
                          <label htmlFor="inline-radio" className="uppercase ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">1990</label>
                      </div>
                      <div className="flex items-center">
          ...
          <h3 className='uppercase tracking-wide text-black border-b border-gray-400 text-xm font-bold mb-3'>FAMILIARES DIRECTOS</h3>
              <div className="-mx-3 md:flex mb-2">
                ...
                <div className="w-1/4 px-3 mb-6 md:mb-0">
                  ...
                  {/* <input value={data.genero} onChange={e=>setData('genero',e.target.value)} className="hover:bg-gray-300 w-full bg-gray-200 text-black border border-gray-200 rounded py-3 px-4 mb-3" id="genero" type="text" placeholder=""/> */}
                  <select onChange={e=>setData('t_relacion_f',e.target.value)} id="t_relacion_f" className='hover:bg-gray-300 w-full bg-gray-200 text-black border border-gray-200 text-sm rounded py-3 px-4 mb-3 font-medium' name="t_relacion_f">
                    <option value="">-Seleccione-</option>
                ...
                <div className="w-1/4 px-3 mb-6 md:mb-0">
                  ...
                  {/* <input value={data.genero} onChange={e=>setData('genero',e.target.value)} className="hover:bg-gray-300 w-full bg-gray-200 text-black border border-gray-200 rounded py-3 px-4 mb-3" id="genero" type="text" placeholder=""/> */}
                  <select onChange={e=>setData('tipo_documento_f',e.target.value)} id="tipo_documento_f" className='hover:bg-gray-300 w-full bg-gray-200 text-black border border-gray-200 text-sm rounded py-3 px-4 mb-3 font-medium' name="tipo_documento_f">
              ...
              <div className="-mx-3 md:flex mb-2">
                ...
                <div className="w-1/6 px-3 mb-6 md:mb-0">
                  ...
                  {/* <input value={data.genero} onChange={e=>setData('genero',e.target.value)} className="hover:bg-gray-300 w-full bg-gray-200 text-black border border-gray-200 rounded py-3 px-4 mb-3" id="genero" type="text" placeholder=""/> */}
                  <select onChange={e=>setData('genero_f',e.target.value)} id="genero_f" className='hover:bg-gray-300 w-full bg-gray-200 text-black border border-gray-200 text-sm rounded py-3 px-4 mb-3 font-medium' name="genero_f">
                    <option value="">-Seleccione-</option>
                    <option value="MASCULINO">MASCULINO</option>
                    <option value="FEMENINO">FEMENINO</option>
                    <option value="OTRO">OTRO</option>
                ...
                <div className="w-1/6 px-3 mb-6 md:mb-0">
                  ...
                  {/* <input value={data.genero} onChange={e=>setData('genero',e.target.value)} className="hover:bg-gray-300 w-full bg-gray-200 text-black border border-gray-200 rounded py-3 px-4 mb-3" id="genero" type="text" placeholder=""/> */}
                  <select onChange={e=>setData('estado_civil_f',e.target.value)} id="estado_civil_f" className='hover:bg-gray-300 w-full bg-gray-200 text-black border border-gray-200 text-sm rounded py-3 px-4 mb-3 font-medium' name="estado_civil_f">
                    <option value="">-Seleccione-</option>
          ...
          <h3 className='uppercase tracking-wide text-black border-b border-gray-400 text-xm font-bold mb-3'>NIVEL EDUCATIVO</h3>
              <div className="-mx-3 md:flex mb-2">
                ...
                <div className="w-1/4 px-3 mb-6 md:mb-0">
                  ...
                  {/* <input value={data.genero} onChange={e=>setData('genero',e.target.value)} className="hover:bg-gray-300 w-full bg-gray-200 text-black border border-gray-200 rounded py-3 px-4 mb-3" id="genero" type="text" placeholder=""/> */}
                  <select onChange={e=>setData('nivel_educativo_ne',e.target.value)} id="nivel_educativo_ne" className='hover:bg-gray-300 w-full bg-gray-200 text-black border border-gray-200 text-sm rounded py-3 px-4 mb-3 font-medium' name="nivel_educativo_ne">
                    <option value="">-Seleccione-</option>
                    ...
                    <option value="DOCTORADO">ESPECIALIDAD</option>
                ...
                <div className="w-1/4 px-3 mb-6 md:mb-0">
                  ...
                  {/* <input value={data.genero} onChange={e=>setData('genero',e.target.value)} className="hover:bg-gray-300 w-full bg-gray-200 text-black border border-gray-200 rounded py-3 px-4 mb-3" id="genero" type="text" placeholder=""/> */}
                  <select onChange={e=>setData('etapa_ne',e.target.value)} id="etapa_ne" className='hover:bg-gray-300 w-full bg-gray-200 text-black border border-gray-200 text-sm rounded py-3 px-4 mb-3 font-medium' name="etapa_ne">
                    <option value="">-Seleccione-</option>
...
cargo_desempeniado_el:'',fecha_inicio_el: '',fecha_culminacion_el: '',t_lugar_ex_el:'',
          ...
          <h3 className='uppercase tracking-wide text-black border-b border-gray-400 text-xm font-bold mb-3'>EXPERIENCIA LABORAL</h3>
              ...
              <select onChange={e=>setData('tipo_elpu',e.target.value)} id="tipo_elpu" className='hover:bg-gray-300 w-full bg-gray-200 text-black border border-gray-200 text-sm rounded py-3 px-4 mb-3 font-medium' name="tipo_elpu">
                <option value="">-Seleccione-</option>
          ...
          <div>
            {exlaboralData.map(exlaboralDat=>
              <div key={exlaboralDat.id}>
                <div className="bg-white shadow-md border border-sky-500 rounded px-7 pt-5 pb-5 mb-4 flex flex-col">
                     ...
                     <div className="w-1/5 px-3 mb-6 md:mb-0">
                         ...
                         <div id="t_lugar_ex_el" className='hover:bg-gray-300 w-full bg-gray-200 text-black border border-gray-200 text-sm rounded h-7 py-1 px-4 font-medium' name="t_lugar_ex_el">
                     ...
                     <div className="w-2/5 px-3 mb-6 md:mb-0">
                         ...
                         <div id="cargo_desempeniado_el" className='hover:bg-gray-300 w-full bg-gray-200 text-black border border-gray-200 text-sm rounded h-7 py-1 px-4 font-medium' name="cargo_desempeniado_el">
                     ...
                     <div className="w-1/5 px-3 mb-6 md:mb-0">
                         ...
                         <div id="fecha_inicio_el" className='hover:bg-gray-300 w-full bg-gray-200 text-black border border-gray-200 text-sm rounded h-7 py-1 px-4 font-medium' name="fecha_inicio_el">
                     ...
                     <div className="w-1/5 px-3 mb-6 md:mb-0">
                         ...
                         <div id="fecha_culminacion_el" className='hover:bg-gray-300 w-full bg-gray-200 text-black border border-gray-200 text-sm rounded h-7 py-1 px-4 font-medium' name="fecha_culminacion_el">
                 ...
                 <div className="w-full px-3">
                         ...
                         <div id="empresa_elpr" className='hover:bg-gray-300 w-full bg-gray-200 text-black border border-gray-200 text-sm rounded h-7 py-1 px-4 font-medium' name="empresa_elpr">
                ...
                DEPENDENCIA
                         ...
                         <div id="dependencia_elpu" className='hover:bg-gray-300 w-full bg-gray-200 text-black border border-gray-200 text-sm rounded h-7 py-1 px-4 font-medium' name="dependencia_elpu">
                         {exlaboralDat.exlabpublica.dependencia_elpu}
                         </div>
              ...
              <div id="tipo_elpu" className='hover:bg-gray-300 w-full bg-gray-200 text-black border border-gray-200 text-sm rounded h-7 py-1 px-4 font-medium' name="tipo_elpu">
            ...
            <div className="w-1/6 px-3">
                ...
                <div id="num_tipo_elpu" className='hover:bg-gray-300 w-full bg-gray-200 text-black border border-gray-200 text-sm rounded h-7 py-1 px-4 font-medium' name="num_tipo_elpu">
                         {exlaboralDat.exlabpublica.num_tipo_elpu}
                         </div>
                </div>
            </>
              :null}
...
fecha_inicio_ed: '',fecha_culminacion_ed : '', */}
          ...
          <h3 className='uppercase tracking-wide text-black border-b border-gray-400 text-xm font-bold mb-3'>EXPERIENCIA DOCENTE</h3>
              ...
              <select onChange={e=>setData('categoria_ed',e.target.value)} id="categoria_ed" className='hover:bg-gray-300 w-full bg-gray-200 text-black border border-gray-200 text-sm rounded py-3 px-4 mb-3 font-medium' name="categoria_ed">
                <option value="">-Seleccione-</option>
        ...
        <div className="bg-gray-200 p-4 mb-4 rounded-lg">
          ...
          <h3 className='uppercase tracking-wide text-black border-b border-gray-400 text-xm font-bold mb-3'>RESOLUCIONES</h3>
              <div className="-mx-3 md:flex mb-2">
                <div className="w-1/4 px-3 mb-6 md:mb-0">
                  ...
                  {/* <input value={data.genero} onChange={e=>setData('genero',e.target.value)} className="hover:bg-gray-300 w-full bg-gray-200 text-black border border-gray-200 rounded py-3 px-4 mb-3" id="genero" type="text" placeholder=""/> */}
                  <select onChange={e=>setData('tipo_res',e.target.value)} id="tipo_res" className='hover:bg-gray-300 w-full bg-gray-200 text-black border border-gray-200 text-sm rounded py-3 px-4 mb-3 font-medium' name="tipo_res">
                    <option value="">-Seleccione-</option>
          ...
          <div>
            {resolucionesycontratoData.map(resolucionesycontratoDat=>
              <div key={resolucionesycontratoDat.id}>
          ...
          <div className="-mx-3 md:flex mb-2">
                <div className="w-1/4 px-3 mb-6 md:mb-0">
                  ...
                  <div id="tipo_res" className='hover:bg-gray-300 w-full bg-gray-200 text-black border border-gray-200 text-sm rounded py-3 px-4 mb-3 font-medium' name="tipo_res">
                    {resolucionesycontratoDat.tipo_res}
                  </div>
                </div>
                <div className="w-1/4 px-3">
                  <label className="uppercase tracking-wide text-black text-xs font-bold mb-2" htmlFor="cod_res">
                  ...
                  <div className="hover:bg-gray-300 w-full bg-gray-200 text-black border border-gray-200 rounded py-3 px-4 mb-3" id="cod_res">
                    {resolucionesycontratoDat.cod_res}
                  </div>
                </div>
                <div className="w-1/4 px-3 mb-6 md:mb-0">
                  <label className="uppercase tracking-wide text-black text-xs font-bold mb-2" htmlFor="fecha_dic_res">
                  ...
                  <div className='hover:bg-gray-300 w-full bg-gray-200 text-black border border-gray-200 rounded py-3 px-4 mb-3 '  id="fecha_dic_res">
            ...
            <div className='hover:bg-gray-300 w-full bg-gray-200 text-black border border-gray-200 rounded py-3 px-4 mb-3 '  id="documento_val_res">
              ...
              <div className="-mx-3 md:flex ">
                <div className="w-2/5 px-3">
                  ...
                  <textarea disabled rows="8" className="hover:bg-gray-300 w-full bg-gray-200  text-black border border-gray-200 rounded py-3 px-4 mb-3" id="des_art_pri_res" type="text" placeholder="">
                ...
                <div className="w-3/5">
                  ...
                  <div className='hover:bg-gray-300 w-full bg-gray-200 text-black border border-gray-200 rounded py-3 px-4 mb-3 '  id="vigencia_res">
                  ...
                  <div className="hover:bg-gray-300 w-full bg-gray-200 text-black border border-gray-200 rounded py-3 px-4 mb-3" id="categoria_alcanz_res">
                  ...
                  <div className="hover:bg-gray-300 w-full bg-gray-200 text-black border border-gray-200 rounded py-3 px-4 mb-3" id="nivel_alcanz_res">
                  ...
                  <div className="hover:bg-gray-300 w-full bg-gray-200 text-black border border-gray-200 rounded py-3 px-4 mb-3" id="antiguedad_in_res">
                  ...
                  <div className="hover:bg-gray-300 w-full bg-gray-200 text-black border border-gray-200 rounded py-3 px-4 mb-3" id="antiguedad_sa_res">
                  ...
                  <div className="hover:bg-gray-300 w-full bg-gray-200 text-black border border-gray-200 rounded py-3 px-4 mb-3" id="condicion_res">
                  ...
                  <div className="hover:bg-gray-300 w-full bg-gray-200 text-black border border-gray-200 rounded py-3 px-4 mb-3" id="dependencia_res">
                  ...
                  <div className="hover:bg-gray-300 w-full bg-gray-200 text-black border border-gray-200 rounded py-3 px-4 mb-3" id="observacion_res">
        ...
        <div className="bg-gray-200 p-4 mb-4 rounded-lg">
          ...
          <div className="-mx-3 md:flex mb-2">
              <div className="w-1/5 px-3">
                  ...
                  <input disabled value={documentoDat.t_nombre_documento_d} className="hover:bg-gray-300 w-full bg-gray-200 text-black border border-gray-200 rounded py-3 px-4 mb-3" id="t_nombre_documento_d" type="text" placeholder=""/>
                ...
                <div className="w-2/5 px-3">
                  ...
                  <input disabled value={documentoDat.descripcion_documento_d} onChange={e=>setData('descripcion_documento_d',e.target.value)} className="hover:bg-gray-300 w-full bg-gray-200 text-black border border-gray-200 rounded py-3 px-4 mb-3" id="descripcion_documento_d" type="text" placeholder=""/>
                  </div>
                <div className="w-1/6 px-3 mb-6 md:mb-0">
                  <label className="uppercase tracking-wide text-black text-xs font-bold mb-2" htmlFor="fecha_documento_d">
                    Fecha deL DOCUMENTO
                  </label>
                  <input disabled value={documentoDat.fecha_documento_d} onChange={e=>setData('fecha_documento_d',e.target.value)} type="date" className='hover:bg-gray-300 w-full bg-gray-200 text-black border border-gray-200 rounded py-3 px-4 mb-3 '  id="fecha_documento_d" />
                  </div>
                <div className="w-1/4 px-3">
                <label htmlFor="dropzone-file_docext" className="uppercase tracking-wide text-black text-xs font-bold mb-2">documento de validacion</label>
