        ...
        <AuthenticatedLayout auth={auth}>
            ...
            <div className="">
                <div className=" p-6 rounded-lg">
                    <div className="flex justify-between">
                        <h3 className="uppercase tracking-wide text-white text-xl  font-bold ">
                    ...
                    {personalData[0].apellido_paterno === undefined && !most ? (
                        <div
                            className="bg-transparent font-bold text-sm text-center uppercase shadow-md rounded px-7 py-3 mb-2 flex "
                            style={{ color: "red" }}
                        >
                    ...
                    {!most ? (
                        <div className="fondo-princ text-white font-bold text-sm text-center uppercase shadow-md rounded px-7 pt-5 pb-5 mb-4 flex ">
            ...
            ${
                personalData[0].apellido_paterno
                    ...
                    <div
                        style={{ display: nuevo }}
                        className="bg-transparent border-2 border-white p-4 mb-4 rounded-lg"
                    >
                ...
                >
                    ...
                    CERRAR
                            ...
                            {familiaData.map((familiaDat) => (
                                ...
                                //    <div className="bg-transparent shadow-md border border-sky-500 rounded px-7 pt-5 pb-5 mb-4 flex flex-col">
                                //            <div className="-mx-3 md:flex mb-2">
