                ...
                <div key={otrotrabajoDat.id} className="mb-2">
                    <div>
                        <table className="w-full border-collapse border-x border-t border-black ">
                            ...
                            <tbody>
                                <tr>
                                    <td className="border-x border-t h-7 border-black">
                                        {otrotrabajoDat.estado_ot ? (
                                            otrotrabajoDat.estado_ot
                                        ) : (
                                            <>&nbsp;</>
                                        )}
                                    ...
                                    <td className="border-x border-t h-7 border-black">
                                        {otrotrabajoDat.hora_entrada_ot ? (
                                            otrotrabajoDat.hora_entrada_ot
                                        ) : (
                                            <>&nbsp;</>
                                        )}
