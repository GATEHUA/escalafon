...
function ResolucionesycontratoEdit({auth,resolucionesycontratoDataEdit}) {
    const {data, setData,post, processing, reset, errors} = useForm({
        ...
        categoria_alcanz_res : resolucionesycontratoDataEdit.categoria_alcanz_res,
      ...
      const resolucionesycontratoEdit = (e)=>{
        e.preventDefault()
        post(route('resolucionesycontrato.update',resolucionesycontratoDataEdit.id))
      }
  return (
    ...
    <form onSubmit={resolucionesycontratoEdit} encType="multipart/form-data">
