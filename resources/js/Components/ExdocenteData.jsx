                    ...
                    >
                        <div className="-mx-3 md:flex md:mb-2">
                            <div className="md:w-1/4 md:px-3">
                                ...
                                <input
                                    value={
                                        data.catedra_ed ? data.catedra_ed : ""
                                    }
                                    onChange={(e) =>
                                        setData("catedra_ed", e.target.value)
                                    }
                            ...
                            <div className="md:w-1/4 md:px-3 ">
                                ...
                                <select
                                    ...
                                    onChange={(e) =>
                                        setData("categoria_ed", e.target.value)
                                    }
                                    id="categoria_ed"
                        ...
                        <div className="flex justify-center md:justify-start">
                            ...
                            <button
                                onClick={() => setEditingExd(false) && reset()}
                ...
                <>
                    <div className="-mx-3 md:flex md:mb-2">
                        <div className="md:w-1/4 md:px-3">
                            ...
                            <input
                                disabled
                                defaultValue={exdocenteDat.catedra_ed}
                                className="hover:border-blue-600 w-full bg-transparent text-white border border-white rounded py-1 px-4 mb-3"
                                id="catedra_ed"
                                type="text"
                                placeholder=""
                        ...
                        <div className="md:w-1/4 md:px-3">
                            ...
                            <input
                                disabled
                                defaultValue={exdocenteDat.fecha_inicio_ed}
                                type="date"
                                className="hover:border-blue-600 w-full bg-transparent text-white border border-white rounded py-1 px-4 mb-3 "
                                id="fecha_inicio_ed"
                            />
                        ...
                        <div className="md:w-1/4 md:px-3">
                            ...
                            <input
                                disabled
                                defaultValue={exdocenteDat.fecha_culminacion_ed}
                                type="date"
                                className="hover:border-blue-600 w-full bg-transparent text-white border border-white rounded py-1 px-4 mb-3 "
                                id="fecha_culminacion_ed"
                            />
                    ...
                    <div className="-mx-3 md:flex md:mb-2">
                        <div className="md:w-1/2 md:px-3">
                            ...
                            <input
                                disabled
                                defaultValue={exdocenteDat.institucion_ed}
                                className="hover:border-blue-600 w-full bg-transparent text-white border border-white rounded py-1 px-4 mb-3"
                                id="institucion_ed"
                                type="text"
                                placeholder=""
